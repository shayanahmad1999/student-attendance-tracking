                        ...
                        <div class="p-6">
                            ...
                            <div class="flex justify-end">
                                <div class="flex flex-wrap items-center gap-3">
                                    ...
                                    <!-- Grade Dropdown -->
                                    <flux:select wire:model.live="grad" :label="__('Grades')"
                                        placeholder="{{ __('All Grades') }}" class="w-36">
                                        @foreach ($grades as $grade)
                                            <option value="{{ $grade->id }}">{{ __($grade->name) }}</option>
                                        @endforeach
                                    </flux:select>
                                ...
                                @foreach ($students as $student)
                                    <tr :key="{{ $student->id }}">
                                        ...
                                        <td class="h-px w-auto whitespace-nowrap">
                                            <div class="px-6 py-2">
                                                <span
                                                    class="text-sm text-gray-800 dark:text-neutral-200">{{ $student->age }}
                                                    years</span>
...
<script>
    Livewire.on('navigateToIndex', () => {
        Livewire.navigate('{{ route('student.index') }}');
    });
</script>
